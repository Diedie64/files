...
\end{center}
\section*{Hoofdstuk 1 (voor de geintereseerden)}
...
\begin{figure}[H]
    ...
    \caption{opstelingsfotto bij Spectroscopie}
\end{figure}
\begin{itemize}
...
\end{figure}
  ...
  \begin{equation}
    ...
    \tag{2.8}
  \end{equation}
  waarbij $F_{X,0}$ het nulpunt (gebaseert op een set van A0v-sterren)  is van filter $X$.
...
\begin{figure}[H]
    ...
    \caption{Hubble-classificatie classen}
\end{figure}
  ...
  \begin{figure}[H]
      ...
      \caption{onderverdeling visualiosatie}
  \end{figure}
  \begin{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item Hubble type is \textbf{kwalitatief} en $T$ is dus niet direct op een meetbare grootheid gebaseert.
    \end{itemize}
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \item De kosmische achtergrond is vrij laag in het UV-venster, zodat men stervorming met een lage oppervlakthelderheid relatief gemakkelijk kan detecteren.
    \item interpretatieprobleem: UV-straling wordt heel efficiënt uitgedooft door interstellair stof.
...
\begin{itemize}
  ...
  \item Hebben de sterren in het sterrenstelsel hetzelvde spectrum $S(u)$, dan geldt:
  \begin{equation}
    G(u)\propto \int F(v_{los})S(u-v_{los})\,dv_{los}
    \Leftrightarrow G(u)\propto F(u)\otimes S(u)
    \tag{9.3}
  \end{equation}
  waarbij $G(u)$ het geobserveerde spectrum is.
  \item Via de relatie tussen convolutie en Fourier-transformatie geldt dan dat
  \begin{equation}
    \tilde{F}(k)\propto \frac{\tilde{G}(k)}{\tilde{S}(k)}
    \tag{9.4}
  \end{equation}
  \item lijkt gemakelijk, is het niet:
    \begin{itemize}
      \item spectrum is som van spectrum van meerdere sterren en dus meerdere type sterren.
      \item hoge kwaliteit spectrocopische data nodig.
      \item ruis word uitvergroot door deling
    \end{itemize}
\end{itemize}
\subsection*{9.1.3 Kinematische parameters}
\begin{itemize}
  \item LOSVD is moeilijk in zijn geheel af te leiden, darom worden vaak eigenschappen gecaractereiseert. enkele eenvoudige eigenschappen zijn:
  \begin{itemize}
    ...
    \end{equation}
  \end{itemize}
  \item er word een standaardgedaante opgesteld voor LOSVD waarin parameters worden gebruikt, meeste courante model is een gausische:
  \begin{equation}
  F(v_{los})=\frac{1}{\sqrt{2\pi}\sigma_{los}}\exp\left(-\frac{(v_{los}-\bar{v}_{los})^2}{2\sigma_{los}^2}\right)
  \tag{9.7}
  \end{equation}
  \item meestal zijn we geintereseert in de vorm van de LOSVD. Deze is namelijk niet altijd gaussisch, er kunnen afwijkingen in zitten die informatie kunnen geven over de kinematische structuur.
  ...
  \tag{9.8}
  \end{equation}
  deze word vaak afgebroken na viede term zodat mogelijke parameters $h_3$ (skewness), $h_4$ (kurtosis), $\sigma^2_{los}$ en $\bar{v}_{los}$ zijn.
\end{itemize}
\section*{9.2 het fundamentele vlak (FV)}
\subsection*{9.2.1 De Faber-Jackson-relatie}  
\begin{itemize}
  \item uit doppler verschuiving van galaxy kan de radiele snelheid en de snelheidsdispersie $\sigma_0$ van het galaxy worden afgeleid.
  \item omdat de centrale gebieden van het galaxy helderder zijn dan de randgebieden, is $\sigma_0$ ongeveer gelijk aan de snelheidsdispersie lmagsheen de centrale kijklijn.
  \item deze dispersie is een belangerijke parrameter:
  \begin{itemize}
    \item hij is een maat voor de massa van een galax: hoe masiever het galaxy, hoe sneller de sterren er in bewegen.
    \item hij stata in relatie met de lichtkracht van een galaxy:
    \begin{equation}
...
\begin{itemize}
  \item de schatter in de Faber-Jackson-relatie kan m.b.v de effectieve straal geilimineert worden cia de relatie $L=2\pi \langle I\rangle_eR_e^2$:
  ...
  \tag{9.10}
  \end{equation}
  \item door elliptische galaxieen in clusters te onderzoeken kan het FV bepaald worden. door dan te vergelijken met andere FV's kunnen standaard waarden voor $\alpha$, $\beta$ gevonden wroden:
  \begin{equation}
  \alpha=1.24\pm0.07 \quad \text{en} \quad \beta=-0.82\pm0.02
  \tag{9.11}
  \end{equation}
  $\Gamma$ verschilt ook niet veel van cluster tot cluster. het fundamenteel vlak is universeel.
\end{itemize}
...
\begin{itemize}
  ...
  \item een sterrenstelsel in evenwicht voldoet aan het viriaal theorema:
  \begin{equation}
  2T_{tot} + W_{tot}= 0
  \tag{9.12}
  \end{equation}
  \item $\langle R\rangle$ en $\langle v^2\rangle$ worden gdefinieert als:
  \begin{equation}
  ...
  \tag{9.13}
  \end{equation}
  \item er geld ook volgende relaties:
  \begin{equation}
  ...
  \item we deffinieren ook de massalichtverhouding $\Upsilon$ als:
  \begin{equation}
  ...
  \tag{9.17}
  \end{equation}
  \item vergelijk deze relatie met (9.10) dan vinden we:
  \[
  \frac{k_S}{\Upsilon} \propto \sigma_0^{\alpha-2}\langle I\rangle_e^{\beta+1}
  \]
  deze uitdrukking beschrijft de helling van het fundamenteel vlak, deze heeft twee oorzakken:
  \begin{itemize}
