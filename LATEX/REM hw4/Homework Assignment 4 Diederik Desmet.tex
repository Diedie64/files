...
\section*{Problem 4}
\subsection*{a.}
when an magnetic field is place over the diamagnetic sphere, an opposite magnetic field will be induced inside the sphere. thus the magnetich field lines wil have the following form:
\begin{figure}[H]
    \centering    
    \includegraphics[width=0.4\textwidth, angle=90]{sphear.png}
    \caption{Magnetic field lines around the diamagnetic sphere}
\end{figure}
\end{document}