...
\[
\mathbf{B}_{in} = \frac{3}{2}\epsilon_0 \mathbf{M}
\]
so that the totral magnetic field inside the sphere is given by:
\[
\mathbf{B} = \mathbf{B}_0 + \mathbf{B}_{in} = B_0\hat{\mathbf{z}} + \frac{3}{2}\epsilon_0 \mathbf{M}
\]
we also have that the total magnetic field inside the sphere is given by:
\[
\mathbf{B} = \mu_0(\mathbf{H}+\mathbf{M})
\]
and that the magnitization is related to the H-field via the relation:
\[
...
\[
\boxed{
\mathbf{B} = \frac{3-3|\chi_m|}{3-|\chi_m|}B_0\hat{\mathbf{z}}
}
\]
using the urlier relations we can calculate the H-field inside and outside the sphere respectively as:
\[\boxed{\mathbf{H}_{in} = \frac{3}{3-|\chi_m|}\frac{B_0}{\mu_0}\hat{\mathbf{z}}} \quad \boxed{\mathbf{H}_{out} = \frac{B_0}{\mu_0}\hat{\mathbf{z}}}
\]
...
\subsection*{a.}
\subsection*{b.}
beacause the scalair potential vanishes, we have that the electric- and magnetic field can be calculated respectively as:
\[\mathbf{E}=-\frac{\partial \mathbf{A}}{\partial t} \quad \mathbf{B}=\nabla\times\mathbf{A}\]
plugging in the given vector potential we find that:
\[
\subsection*{c.}
